  ...
  const gcpNodes: GcpNode[] = [
    {
      ...
      productionBlueprint: "Integrates Maps Web API SDK directly on Leaflet/WebGL wrappers, authenticating via strict HTTP referrer restrictions keys."
    },
    {
      id: "functions",
      ...
      productionBlueprint: "Deploy Node.js 20 serverless functions subscribing to Cloud Pub/Sub topics to process raw sensor feeds on-the-fly."
    },
    {
      id: "gemini",
      name: "Gemini Pro API",
      ...
      productionBlueprint: "Linked to Vertex AI Gemini API endpoint via Node.js secure proxy handlers, managing tokens budgets and caching presets."
    },
    {
      id: "bigquery",
      ...
      productionBlueprint: "Aggregates events stream via Pub/Sub streaming buffer inserts, feeding Looker dashboards for stadium ops command rooms."
    },
    {
      id: "analytics",
      ...
      productionBlueprint: "Linked to Firebase Analytics tags on mobile PWAs, tracking screen views and average session durations."
    },
    {
      id: "firestore",
      ...
      productionBlueprint: "Configured with Realtime listeners subscribing to collections. Replicated multi-region to guarantee MetLife Arena 99.999% uptime."
    }
  ];
    ...
    <div className="flex flex-col gap-6 text-left font-sans min-h-[80vh]">
      ...
      <Card variant="glass" className="border-neutral-800 bg-neutral-950/60 backdrop-blur-xl relative overflow-hidden">
        <CardHeader className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <CardTitle className="text-white text-2xl font-bold">System Architecture Showcase</CardTitle>
            <CardDescription className="text-neutral-400 text-xs">
              Interactive blueprint demonstrating multi-agent systems coordination and telemetry reporting schemas.
            </CardDescription>
          </div>
      ...
      {animatingIndex !== null && (
        <div className="p-3 rounded-xl border border-victory-gold/20 bg-victory-gold/5 flex items-center justify-between text-xs text-victory-gold font-semibold animate-pulse">
          ...
          <span className="font-mono text-[9px] uppercase">Step {animatingIndex + 1} of {gcpNodes.length}</span>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
        ...
        <div className="lg:col-span-7 flex flex-col">
          <Card variant="glass" className="flex-grow flex flex-col p-6 border-neutral-800 bg-neutral-950/60 backdrop-blur-xl relative justify-between min-h-[400px]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
                ...
                <div className="flex flex-col gap-6 justify-center">
                  <button
                    ...
                    className={`p-4 rounded-xl border text-left flex items-start gap-3 transition-all ${
                      selectedNode.id === "analytics" ? "border-emerald-500 bg-emerald-500/10 scale-105" : "border-neutral-800 hover:border-neutral-700 bg-neutral-955/40"
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-[9px] text-neutral-500 mt-0.5 uppercase font-mono">Telemetry</div>
                    </div>
                  </button>
                  ...
                  <button
                    ...
                    className={`p-4 rounded-xl border text-left flex items-start gap-3 transition-all ${
                      selectedNode.id === "maps" ? "border-purple-500 bg-purple-500/10 scale-105" : "border-neutral-800 hover:border-neutral-700 bg-neutral-955/40"
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-[9px] text-neutral-500 mt-0.5 uppercase font-mono">Routing AI</div>
                    </div>
                  </button>
                </div>
                ...
                <div className="flex flex-col gap-6 justify-center">
                  <button
                    ...
                    className={`p-4 rounded-xl border text-left flex items-start gap-3 transition-all ${
                      selectedNode.id === "functions" ? "border-sky-500 bg-sky-500/10 scale-105" : "border-neutral-800 hover:border-neutral-700 bg-neutral-955/40"
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-[9px] text-neutral-500 mt-0.5 uppercase font-mono">Orchestration</div>
                    </div>
                  </button>
                  ...
                  <button
                    ...
                    className={`p-4 rounded-xl border text-left flex items-start gap-3 transition-all ${
                      selectedNode.id === "gemini" ? "border-purple-500 bg-purple-500/10 scale-105" : "border-neutral-800 hover:border-neutral-700 bg-neutral-955/40"
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-[9px] text-neutral-500 mt-0.5 uppercase font-mono">Cognitive AI</div>
                    </div>
                  </button>
                </div>
                ...
                <div className="flex flex-col gap-6 justify-center">
                  <button
                    ...
                    className={`p-4 rounded-xl border text-left flex items-start gap-3 transition-all ${
                      selectedNode.id === "firestore" ? "border-amber-500 bg-amber-500/10 scale-105" : "border-neutral-800 hover:border-neutral-700 bg-neutral-955/40"
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-[9px] text-neutral-500 mt-0.5 uppercase font-mono">State DB</div>
                    </div>
                  </button>
                  ...
                  <button
                    ...
                    className={`p-4 rounded-xl border text-left flex items-start gap-3 transition-all ${
                      selectedNode.id === "bigquery" ? "border-amber-500 bg-amber-500/10 scale-105" : "border-neutral-800 hover:border-neutral-700 bg-neutral-955/40"
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-[9px] text-neutral-500 mt-0.5 uppercase font-mono">Data Warehouse</div>
                    </div>
                  </button>
                </div>
              </div>
            ...
            <div className="mt-4 pt-3.5 border-t border-neutral-900 flex items-center justify-between text-[11px] text-neutral-400 font-semibold">
              ...
              <span className="text-neutral-500 uppercase text-[9px] font-mono">Mock integration Layer active</span>
            </div>
          </Card>
        </div>
        ...
        <div className="lg:col-span-5 flex flex-col">
          <Card variant="glass" className="flex-grow flex flex-col border-neutral-800 bg-neutral-950/60 backdrop-blur-xl p-0 overflow-hidden text-xs">
            <div className={`p-5 border-b border-neutral-900 flex items-center gap-3 ${catColors[selectedNode.category as keyof typeof catColors]}`}>
            ...
            <div className="p-5 flex-grow flex flex-col gap-4 text-left leading-relaxed">
              {/* Role */}
              <div>
                <div className="text-[10px] text-neutral-500 font-bold uppercase mb-1">Functional Stadium Role</div>
                <p className="text-neutral-200">{selectedNode.role}</p>
              </div>

              {/* Telemetry emitted */}
              <div>
                <div className="text-[10px] text-neutral-500 font-bold uppercase mb-1">BigQuery Telemetry Event Schema</div>
              ...
              {/* Mock parameters */}
              <div>
                <div className="text-[10px] text-neutral-500 font-bold uppercase mb-1">Payload Variables Mocked</div>
                <div className="flex flex-wrap gap-1.5 pt-0.5">
                  {selectedNode.mockParams.map((p, idx) => (
                    <span key={idx} className="px-2 py-0.5 rounded bg-neutral-900 border border-neutral-800 text-[10px] text-neutral-300 font-mono font-medium">
                      {p}
                    </span>
                  ))}
                </div>
              ...
              <div className="pt-3.5 border-t border-neutral-900/60 flex-grow">
                ...
                <p className="text-neutral-400 text-[11px] leading-relaxed">{selectedNode.productionBlueprint}</p>
              </div>
            </div>
          </Card>
        </div>
