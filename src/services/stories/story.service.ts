  ...
  private static storySteps: StoryStep[] = [
    {
      ...
      description:
        "The Miller family (parents + 2 kids) approaches stadium. AI greets them warmly, preloading baby-care maps.",
      phase: "arrival",
      density: 0.8,
      emergency: null,
      activeLanguage: "en",
      ...
      expectedOutcome:
        "Welcomes family, loads baby changing station layers, recommends train arrival walkway.",
    ...
    },
    {
      ...
      description:
        "Turnstiles congestion spikes. AI detects potential family stress, advising a reroute to Gate A North.",
      phase: "gate-entry",
      density: 1.6,
      emergency: null,
      activeLanguage: "en",
      activePersona: "family",
      expectedOutcome:
        "Redirects from congested Gate B to Gate A North, saving 11 minutes of waiting.",
    ...
    },
    {
      ...
      description:
        "Young child gets separated near concessions. Incident is logged; security coordinates active search.",
      phase: "halftime",
      density: 1.2,
      ...
      activePersona: "family",
      expectedOutcome:
        "Triggers lost child playbook: freezes exits, dispatches volunteers, updates parent chat.",
    ...
    },
    {
      ...
      description:
        "Volunteer Sector 110 receives the security alert, locates the minor, and guides them back safely.",
      phase: "second-half",
      density: 1.0,
      emergency: "LOST CHILD SEC 110",
      ...
      expectedOutcome:
        "Translates phrasebook macros; confirms child matching identity; alerts family.",
    ...
    },
    {
      ...
      description:
        "Match completes. AI guides the family to Platform 3 transit express to exit safely before exit queues peak.",
      phase: "exit",
      density: 1.4,
      emergency: null,
      activeLanguage: "en",
      activePersona: "family",
      expectedOutcome:
        "Directs family to Platform 3 shuttle boarding, ensuring 100% stress-free transit home.",
