  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 text-left font-sans">
      ...
      <div className="lg:col-span-5 flex flex-col gap-6">
        ...
        >
          <CardHeader className="pb-3 border-b border-neutral-900">
            ...
            <CardTitle className="text-white text-base mt-1">
            ...
            <div className="p-3 bg-neutral-900/40 border border-neutral-850 rounded-xl flex flex-col gap-3 justify-between">
              ...
              <div className="flex flex-col gap-2 relative">
                ...
                <div className="p-2 bg-neutral-950 rounded-lg border border-rose-950 text-rose-400 font-medium">
                  <span className="text-[8px] uppercase text-neutral-500 block">
                    1. Previous Congestion
                  </span>
                ...
                <div className="p-2 bg-neutral-950 rounded-lg border border-cyber-green/20 text-cyber-green font-medium">
                  <span className="text-[8px] uppercase text-cyber-green block">
                    3. Better Outcome (+{selectedRecord.improvementPercent}%)
                  </span>
      ...
      <div className="lg:col-span-7 flex flex-col gap-6">
        <Card
          variant="glass"
          className="border-neutral-850 bg-neutral-950/60 backdrop-blur-xl flex-grow"
        >
          <CardHeader className="pb-3 border-b border-neutral-900">
              ...
              <tbody className="divide-y divide-neutral-900/60">
                {decisionHistory.map((dec, idx) => (
                  <tr key={idx} className="hover:bg-neutral-900/20">
                    <td className="py-2.5 font-semibold text-white max-w-[110px] break-words">
                      {dec.problem}
                    </td>
                    ...
                    <td className="py-2.5 text-center font-mono text-victory-gold font-bold">
                      {dec.confidence}%
                    </td>
