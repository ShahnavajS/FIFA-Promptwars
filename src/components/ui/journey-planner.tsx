...
const CHECKPOINTS: Checkpoint[] = [
  {
    ...
    phases: ["pre-match"],
    aiGuidance: "Welcome to matchday! Meadowlands rail links are running on-time. Make sure to download your mobile ticket TKT-128456-M89D to your offline wallet before departing.",
  },
  {
    id: "transit",
    label: "Metro Transit",
    ...
    phases: ["arrival"],
    aiGuidance: "Fan shuttle bus lines are congested (24 min wait). Meadowlands express rail is recommended; trains are departing every 10 minutes from platform 3.",
  },
  {
    id: "security",
    ...
    phases: ["security"],
    aiGuidance: "Bag scanners are experiencing average throughput. Avoid the central terminal corridors; walk around to the North perimeter for shorter lanes.",
  },
  {
    id: "gate",
    label: "Gate Ingress",
    ...
    phases: ["gate-entry"],
    aiGuidance: "Gate B is congested (28 min queue). StadiumPulse recommends rerouting to Gate A North; walk time is 4 minutes and has immediate entry.",
  },
  {
    id: "seat",
    label: "Locate Seat",
    ...
    aiGuidance: "Your seat is in Sector 112, Row F. Ingress via the West Lift Core for step-free ramps. Lifts are fully operational.",
  },
  {
    id: "break",
    label: "Concessions",
    ...
    phases: ["halftime"],
    aiGuidance: "Halftime is active. Restroom Sector 103 queue is 2 minutes. For tacos, check El Tri Tacos at Sector 102 (4 min wait) rather than the Maple counter.",
  },
  {
    id: "exit",
    label: "Exit Stadium",
    ...
    aiGuidance: "Match has concluded. Exits are active. Rideshare Zone 1 is heavily congested (35 min surge). Take Metro Transit loops from Gate A exit gates.",
  },
];
          ...
          {CHECKPOINTS.map((c, idx) => {
            ...
            return (
              <div key={c.id} className="relative flex flex-col gap-0.5">
                {/* Node Dot */}
                <div className={`absolute -left-[31px] top-1 h-4.5 w-4.5 rounded-full flex items-center justify-center border transition-all ${
                  isActive 
