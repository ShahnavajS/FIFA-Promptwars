  ...
  public static getStadiumMood(
    ...
    if (activeEmergency) {
      return {
        ...
        color: "text-rose-500",
        animationSpeed: 1.8,
        microcopy: "SAFETY PROTOCOLS ENGAGED: Our priority is your safety. Follow volunteer exit routing markers.",
    ...
    switch (phase) {
      ...
      case "security":
        return {
          ...
          animationSpeed: 0.8,
          microcopy: "WELCOME TO METLIFE ARENA: World Cup 2026 preparations underway. Enjoy your matchday experience!",
      ...
      case "pre-kickoff":
        return {
          ...
          color: "text-cyan-400",
          animationSpeed: 1.0,
          microcopy: "ANTICIPATION BUILDING: Find your seat rows. Match kickoff is approaching shortly.",
      ...
      case "second-half":
        return {
          ...
          animationSpeed: 1.4,
          microcopy: "MATCH LIVE: Argentina vs. Germany. Stadium solar energy capture running at 94% capacity offsets.",
      ...
      case "halftime":
        return {
          ...
          animationSpeed: 0.5,
          microcopy: "HALFTIME INTERVAL: Take a break. Concessions restroom load routing is currently active.",
      ...
      case "full-time":
        return {
          ...
          animationSpeed: 1.6,
          microcopy: "ARGENTINA VICTORY! Confetti celebration active. What a memorable tournament matchday!",
      ...
      case "post-match":
        return {
          ...
          color: "text-neutral-400",
          animationSpeed: 0.6,
          microcopy: "THANK YOU FOR ATTENDING: Safe travels home. Proceed to Platform 3 Meadowlands transit rail loop.",
