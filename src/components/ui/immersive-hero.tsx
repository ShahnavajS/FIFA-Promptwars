...
const HOST_CITIES = [
  { name: "New York/New Jersey", lat: 40.7128, lng: -74.0060 },
  ...
  return (
    <div className="relative h-[400px] w-full max-w-[450px] select-none pointer-events-auto flex items-center justify-center">
      ...
      <Canvas camera={{ position: [0, 0, 5.2], fov: 55 }}>
        ...
        <Stars radius={100} depth={50} count={250} factor={4} saturation={0.5} fade speed={reducedMotion ? 0 : 0.5} />
        <OrbitControls
          enableZoom={false}
          enablePan={false}
  ...
  return (
    <div className="relative h-[400px] w-full max-w-[450px] flex items-center justify-center select-none">
      ...
      >
        ...
        <path d="M14.6 50 A 35.4 35.4 0 0 1 85.4 50" fill="none" stroke="currentColor" strokeWidth="0.25" />
        <path d="M14.6 50 A 35.4 35.4 0 0 0 85.4 50" fill="none" stroke="currentColor" strokeWidth="0.25" />
