...
export function AIBrainPipeline() {
  ...
  const nodes: PipelineNode[] = [
    ...
    },
    {
      ...
      auditDetails: {
        prompt:
          "DIRECTIONS_API_REQUEST: Origin='Secaucus Plat 3', Destination='Sector 112, Row F', Mode='walking', StepFree=true",
        reasoning: [
    ...
    },
    {
      ...
      auditDetails: {
        prompt:
          "You are StadiumPulse AI. Under ERGP formatting guidelines, generate guidance for the Martinez family stuck in queue B. Current stress: High. Tone: Enthusiastic.",
        reasoning: [
  ...
  return (
    <section
      id="ai-brain-pipeline"
      className="py-28 bg-[#04060c] border-t border-neutral-900 px-6 scroll-mt-16 relative"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1 lg:col-span-5 space-y-6 text-left">
            ...
            <p className="text-neutral-400 text-sm sm:text-base leading-relaxed">
              StadiumPulse AI serves as the central operations cockpit, mapping complex stadium
              telemetry onto live digital twins. Our pipeline ingests sensor feeds, runs real-time
              maps solving, and dispatches empathetic assistance via Gemini.
            </p>
          </div>
          ...
          <div className="order-1 lg:order-2 lg:col-span-7 flex justify-center">
            ...
            >
              ...
              <svg
                className="absolute inset-0 w-full h-full opacity-40 group-hover:opacity-80 transition-opacity duration-500 z-15 pointer-events-none"
              ...
              <div className="absolute top-[8%] left-[6%] z-20 bg-neutral-950/75 border border-[#ffffff10] backdrop-blur-md px-2 py-1.5 sm:px-3.5 sm:py-2.5 rounded-xl sm:rounded-2xl flex items-center gap-1.5 sm:gap-2.5 shadow-lg group-hover:-translate-y-1.5 transition-transform duration-350">
                ...
                <div className="text-left font-mono">
                  <span className="text-[5.5px] sm:text-[7.5px] text-neutral-400 uppercase tracking-wider block font-bold leading-none">
                    🟢 Stadium Health
                  </span>
                  <span className="text-[9px] sm:text-sm font-extrabold text-white mt-0.5 block leading-none">
                    98%
                  </span>
                </div>
              </div>
              ...
              <div className="absolute bottom-[8%] right-[6%] z-20 bg-neutral-950/75 border border-[#ffffff10] backdrop-blur-md px-2 py-1.5 sm:px-3.5 sm:py-2.5 rounded-xl sm:rounded-2xl flex items-center gap-1.5 sm:gap-2.5 shadow-lg group-hover:-translate-y-1.5 transition-transform duration-350 delay-150">
                ...
                <div className="text-left font-mono">
                  ...
                  <span className="text-[8px] sm:text-xs font-extrabold text-white mt-0.5 block leading-none">
                    All Routes Clear
                  </span>
                </div>
              </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-6 relative z-10">
            {nodes.map((n) => {
              ...
              return (
                ...
                >
                  <div
                    className={`h-16 w-16 rounded-2xl flex items-center justify-center border transition-all duration-300 relative ${
                      active
                  ...
                  >
                    ...
                    <Icon
                      className={`h-6.5 w-6.5 ${active ? n.color : "text-neutral-500 group-hover:text-white"}`}
                    />
                  </div>
                  <div>
                    <div
                      className={`text-xs font-extrabold tracking-tight ${active ? "text-white" : "text-neutral-400"}`}
                    >
                      {n.label.split(". ")[1]}
                    </div>
                    <div className="text-[9px] text-neutral-500 font-bold uppercase mt-0.5 font-mono">
                      {n.sub}
                    </div>
                  </div>
                </button>
            ...
            >
                  ...
                  <div className="flex flex-col gap-2 pl-4 border-l border-neutral-900">
                    {active.auditDetails.reasoning.map((step, idx) => (
                      <div key={idx} className="relative flex items-center gap-2">
                        ...
                        <span className="text-[11px] text-neutral-300 font-medium font-sans">
                          {step}
                        </span>
                      </div>
                    ))}
              ...
              <div className="lg:col-span-5 text-left p-6 rounded-3xl border border-neutral-900 bg-neutral-950/80 font-mono text-[10px] space-y-4 relative overflow-hidden flex flex-col justify-between">
                ...
                <div className="space-y-4">
                  ...
                  {/* Confidence */}
                  <div>
                    <span className="text-neutral-500 uppercase text-[8px] font-bold block mb-1">
                  ...
                  <div className="space-y-2">
                    <span className="text-neutral-500 uppercase text-[8px] font-bold block">
                      Evidence factors checked
                    </span>
